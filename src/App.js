  ...
  return (
   <div className='main'>
    ...
    <div className='mn'>
		...
		<p className='p-text'>
		2002年生まれの神奈川県出身です。個人事業主として活動しており、コーポレートサイトのコーディングとデザインをメインに仕事しています。<br>これまで十数社のコーポレートサイトとランディングページの作成に携わりました。<br>また、現在はフロントエンド開発にも挑戦し、JavaScriptの特定のフレームワークを学習中です。<br>お客様のニーズに合わせてデザインからコーディングまでワンストップで対応しています
...
<div className='card'>
  ...
  <div className='c-txt'>ユーザーに伝えたい内容を<br/>見やすいデザインに落とし込み投稿の可読性を引き上げます。</div>
</div>
</div>
